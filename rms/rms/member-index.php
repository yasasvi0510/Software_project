...
<a href="member-profile.php">My Profile</a> |  <a href="inbox.php">Inbox[<?php echo $num_messages;?>]</a> | <a href="cart.php">Cart[<?php echo $num_items;?>]</a> | <a href="logout.php">Logout</a> <!-- | <a href="ratings.php">Rate Us</a>  | <a href="partyhalls.php">Party-Halls</a> | <a href="tables.php">Tables</a> -->
<p>&nbsp;</p>
<p>Here you can view order history and delete old orders from your account. Invoices can be viewed from the order history. For more information <a href="contactus.php">Click Here</a> to contact us.
...
echo '<td><a href="delete-order.php?id=' . $row['order_id'] . '">Delete Order</a></td>';
echo "</tr>";
}
