...
<h1>My Profile</h1>
  <div style="border:#bd6f2f solid 1px;padding:4px 6px 2px 6px">
		<a href="member-index.php">Home</a> | <a href="cart.php">Cart[<?php echo $num_items;?>]</a> | <a href="logout.php">Logout</a> <!-- | <a href="ratings.php">Rate Us</a> |  <a href="inbox.php">Inbox[<?php echo $num_messages;?>]</a> | <a href="partyhalls.php">Party-Halls</a> | <a href="tables.php">Tables</a> -->
<p>&nbsp;</p>
